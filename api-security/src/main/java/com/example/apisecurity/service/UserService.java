...
public class UserService {
    ...
    public Login login(String email, String password){
        var user = userDao.findUserByEmail(email).orElseThrow(InvalidCredentialError::new);
    ...
    public Login refreshAccess(String refreshToken){
        ...
        var user = userDao.findUserIdAndTokenByRefreshToken(refreshJwt.getUserId(),
                refreshJwt.getToken()
    ...
    public Boolean logout(String refreshToken){
        ...
        var refreshJwt = Jwt.from(refreshToken,refreshSecret);
        var user = userDao.findById(refreshJwt.getUserId()).orElseThrow(UserNotFoundException::new);

        var tokenIsRemoved = user.removeTokenId(token ->
